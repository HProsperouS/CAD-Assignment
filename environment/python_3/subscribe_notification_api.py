...
# Create the 'subscribe_notification' resource
subscribe_notification_resource_id = client.create_resource(
    restApiId=api_id,
    parentId=parent_id,
    pathPart='subscribe_notification'
)["id"]

# Add the POST method to the 'subscribe_notification' resource
post_method_response = client.put_method(
    restApiId=api_id,
    resourceId=subscribe_notification_resource_id,
    httpMethod='POST',
