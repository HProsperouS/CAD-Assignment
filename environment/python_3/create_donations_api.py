...
# Create the 'donations' resource
donations_resource_id = client.create_resource(
    restApiId=api_id,
    parentId=parent_id,
    pathPart='donations'
)["id"]

# Add the GET method to the 'donations' resource
get_method_response = client.put_method(
    restApiId=api_id,
...
# Set up the 200 response for the GET method
...
# Add the POST method to the 'donations' resource
