...
S3_KEY = 'create_donation_code.zip'  # The zip file containing your Lambda function code
...
def create_lambda_function():
    try:
        response = lambda_client.create_function(
            ...
            Description='Lambda function to create donation.',
            Environment={
                'Variables': {
