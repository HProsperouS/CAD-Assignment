...
S3_KEY = 'get_donations_code.zip'  # The zip file containing your Lambda function code
...
def create_lambda_function():
    try:
        response = lambda_client.create_function(
            ...
            Description='Lambda function to get categories from RDS.',
            Environment={
                'Variables': {
